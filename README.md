...
![启动](https://github.com/user-attachments/assets/341436c3-a9eb-4929-af1c-3fbf1987c1f4)
...
### 🎓 校园日常管理
- **智能课程表**: 自动从西电教务系统同步课程安排![课表](https://github.com/user-attachments/assets/14e49e80-f85e-47da-bfc1-b82a875afa12)

- **实时状态**: 显示当前正在上的课和下节课信息<img width="2518" height="1019" alt="image" src="https://github.com/user-attachments/assets/cd04176c-efec-4012-8cc1-28666fbd1011" />
...
### 🤖 AI对话功能
- **多会话管理**: 创建和管理多个独立的对话会话<img width="496" height="1511" alt="image" src="https://github.com/user-attachments/assets/983f0d03-dcfa-4a30-b477-57c3b5b340b9" />

- **智能体选择**: 从预设或自定义智能体中选择对话伙伴![助手](https://github.com/user-attachments/assets/55686582-44e3-4976-938c-dd0ae13fd731)

- **多模态输入**: 支持文本、图片、文档等多种输入方式<img width="1872" height="761" alt="image" src="https://github.com/user-attachments/assets/371b4fa1-ab3f-4668-80d7-3d4cc337bf06" />

- **实时流式响应**: 打字机效果的实时响应体验
- **思考过程可视化**: 支持o1、Gemini Thinking等模型的思考过程展示
- **上下文管理**: 可配置的对话历史管理（0-20条消息）<img width="480" height="1041" alt="image" src="https://github.com/user-attachments/assets/70432612-83d7-43d8-af4d-86c5b85ad186" />


### 👥 智能体管理
- **智能体创建**: 创建学习助手、编程助手、写作助手等角色<img width="2519" height="1479" alt="image" src="https://github.com/user-attachments/assets/3f6cac89-40a8-47ad-8626-3d1292a5eeeb" />
